###
#markdown 형식으로 만들것 (chunking)
#vecterdb는 -> milvus db 사용
#milvus db 연결하고 collection -> table만드는데(markdown 형식, chunking)
#그다음 embedding을 하여 collection을 저장 -> milvus
###
...
def generate_query_embedding(queries:list):
    """
