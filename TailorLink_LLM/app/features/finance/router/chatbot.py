...
from app.features.finance.nodes.rag_pipeline import run_finance_chatbot
finance_qa_router = APIRouter()
...
@finance_qa_router.post("/finance", response_model=ChatResponse)
async def chat(chat_request: ChatRequest):
    logger.info('Running finance chatbot')
    ...
    res = run_finance_chatbot(user_input, car_id, conversation_history)
