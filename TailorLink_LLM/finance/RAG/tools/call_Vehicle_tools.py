...
def get_brand_list_tool(headers: dict) -> dict:
    """
...
def get_model_list_tool(headers: dict, brand_code: str) -> dict:
    """
...
def get_year_list_tool(headers: dict, brand_code: str, model_code: str, start_date: str) -> dict:
    """
...
def get_detail_list_tool(headers: dict, brand_code: str, model_code: str, year_code: str) -> dict:
    """
...
def get_option_list_tool(headers: dict, brand_code: str, model_code: str, year_code: str, detail_code: str) -> dict:
    """
